...
> ✨ **Versão do Sistema**: Debian GNU/Linux 12.11 (Bookworm)> 🌐 **Hostname**: `server`> 🌐 **Domínio**: `mydomain.lan`> 🚀 **Endereço IP**: `192.168.0.254/24`> 🔐 **Gateway**: `192.168.0.1`> 🔎 **DNS Forwarders**: Cloudflare (`1.1.1.1`), Google (`8.8.8.8`), OpenDNS (`208.67.222.222`)
